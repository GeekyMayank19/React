...
const Post = () => {
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ marginLeft: 5, cursor: "pointer" }}>
            <div style={{ fontWeight: "600", fontSize: "14px", marginTop: -1 }}>
              Name
            </div>
            <div style={{ fontWeight: "600", fontSize: "13px", marginTop: -6 }}>
              University
            </div>
            <div style={{ fontWeight: "600", fontSize: "13px", marginTop: -6 }}>
              Profile
      ...
       
      <h6 className="question" style={{ marginTop: -20, marginLeft: 5 }}>
      ...
      >
        ...
        <div style={{ marginLeft: "3px", fontWeight: "500", fontSize: 12 }}>
          34
        </div>
        <ShareSharpIcon
          color="info"
